    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        if (args.length == 0) {
            sender.sendMessage(new String[]{
                    ...
                    Style.translate("&e/collector set <collectionType> <amount> &7- &dSet amounts of collection type in a collector you are stood above."),
                    Style.translate("&e/collector remove &7- &dRemoves a collector from the chunk you are standing in.")
            });
        }
